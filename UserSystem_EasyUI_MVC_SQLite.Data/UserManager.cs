...
namespace UserSystem_EasyUI_MVC_SQLite.Data
{
	/// <summary>
	/// 数据访问类:UserManager
	/// </summary>
	public partial class UserManager
	{
		...
		public UserSystem_EasyUI_MVC_SQLite.Model.UserManager GetModel(int ID)
		{
			...
			UserSystem_EasyUI_MVC_SQLite.Model.UserManager model=new UserSystem_EasyUI_MVC_SQLite.Model.UserManager();
		...
		/// 得到一个对象实体
		/// </summary>
		public UserSystem_EasyUI_MVC_SQLite.Model.UserManager DataRowToModel(DataRow row)
		{
			UserSystem_EasyUI_MVC_SQLite.Model.UserManager model=new UserSystem_EasyUI_MVC_SQLite.Model.UserManager();
			if (row != null)
			{
