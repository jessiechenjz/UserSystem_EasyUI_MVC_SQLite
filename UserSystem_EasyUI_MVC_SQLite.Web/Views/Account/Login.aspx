...
<body>
    <div id="win" class="easyui-window" title="登录系统" style="width:260px;height:180px;"   
        data-options="iconCls:'icon-save',modal:true,closable:false,minimizable:false,maximizable:false,collapsible:false,draggable:false,resizable:false">   
        <table style="padding-left:10px;padding-top:10px">
            <tr>
                <td>用户名：</td><td><input id="name" type="text" value="admin"/></td>
            </tr>
            <tr>
                <td>密码：</td><td><input id="pwd" type="text" value="12345"/></td>
            </tr>
            <tr>
                <td></td><td></td>
            </tr>
            <tr>
             ...
             <tr>
                <td></td><td><label id="showInfo" style="color:Red"/></td>
            </tr>
        </table>
